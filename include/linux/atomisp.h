...
// #define CUSTOM_IOCTL_REG_SET                    (V4L2_CID_CAMERA_LASTP1 + 32)  //ASUS_BSP++, for calibration
// #define CUSTOM_IOCTL_REG_GET                    (V4L2_CID_CAMERA_LASTP1 + 33)  //ASUS_BSP++, for calibration
// #define CUSTOM_IOCTL_SPI_GET                    (V4L2_CID_CAMERA_LASTP1 + 34)  //ASUS_BSP++, for calibration
