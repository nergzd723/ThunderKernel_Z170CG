...
static int cif_isp20_v4l2_cid2v4l2_cid(u32 cif_isp20_cid)
{
	...
	case CIF_ISP20_CID_3A_LOCK:
		...
		return V4L2_CID_3A_LOCK_ISP;
	case CIF_CUSTOM_IOCTL_REG_SET:
 		return CUSTOM_IOCTL_REG_SET;
	case CIF_CUSTOM_IOCTL_REG_GET:
 		return CUSTOM_IOCTL_REG_GET;
 	case CIF_CUSTOM_IOCTL_SPI_GET:
 		return CUSTOM_IOCTL_SPI_GET;
	...
	case CIF_ISP20_CID_LOW_LIGHT_CAPTURE:
		return V4L2_CID_LOW_LIGHT_CAPTURE;
