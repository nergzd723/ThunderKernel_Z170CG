...
static int cif_isp20_v4l2_cid2cif_isp20_cid(u32 v4l2_cid)
{
	...
	case V4L2_CID_3A_LOCK_ISP:
		return CIF_CUSTOM_CID_3A_LOCK;
	case INTEL_V4L2_CID_AUTO_FPS:
		return CIF_ISP20_CID_AUTO_FPS;
 	case CUSTOM_IOCTL_REG_SET:
		cif_isp20_pltfrm_pr_err(NULL,
			"CUSTOM_IOCTL_REG_SET\n");
		return CIF_CUSTOM_IOCTL_REG_SET;
	case CUSTOM_IOCTL_REG_GET:
		return CIF_CUSTOM_IOCTL_REG_GET;
	case CUSTOM_IOCTL_SPI_GET:
		return CIF_CUSTOM_IOCTL_SPI_GET;
	case V4L2_CID_AUTO_FOCUS_START:
		return CIF_ISP20_CID_AUTO_FOCUS_START;
	case V4L2_CID_PAN_RELATIVE:
		return CIF_ISP20_CID_PAN_RELATIVE;
	case V4L2_CID_TILT_RELATIVE:
		return CIF_ISP20_CID_TILT_RELATIVE;
	case V4L2_CID_PAN_RESET:
		return CIF_ISP20_CID_PAN_RESET;
	case V4L2_CID_TILT_RESET:
		return CIF_ISP20_CID_TILT_RESET;
	case V4L2_CID_PAN_ABSOLUTE:
		return CIF_ISP20_CID_PAN_ABSOLUTE;
	case V4L2_CID_TILT_ABSOLUTE:
		return CIF_ISP20_CID_TILT_ABSOLUTE;
	case V4L2_CID_HDR:
		return CIF_ISP20_CID_HDR;
	case V4L2_CID_AUTO_FOCUS_RANGE:
		return CIF_ISP20_CID_AUTO_FOCUS_RANGE;
	case V4L2_CID_LOW_LIGHT_CAPTURE:
		return CIF_ISP20_CID_LOW_LIGHT_CAPTURE;
	case V4L2_CID_AUTO_FOCUS_STATUS:
		return CIF_ISP20_CID_AUTO_FOCUS_STATUS;
	case V4L2_CID_EXPOSURE_METERING:
		return CIF_ISP20_CID_METERING_MODE;
	default:
		cif_isp20_pltfrm_pr_err(NULL,
