...
enum cif_isp20_cid {
	...
	CIF_CUSTOM_IOCTL_REG_SET = 20,
 	CIF_CUSTOM_IOCTL_REG_GET = 21,
	CIF_CUSTOM_IOCTL_SPI_GET = 22,
	CIF_ISP20_CID_POWER_LINE_FREQUENCY = 23,
	CIF_ISP20_CID_AUTO_FOCUS_START = 24,
	CIF_ISP20_CID_PAN_RELATIVE = 25,
	CIF_ISP20_CID_TILT_RELATIVE = 26,
	CIF_ISP20_CID_PAN_RESET = 27,
	CIF_ISP20_CID_TILT_RESET = 28,
	CIF_ISP20_CID_PAN_ABSOLUTE = 29,
	CIF_ISP20_CID_TILT_ABSOLUTE = 30,
	CIF_ISP20_CID_HDR = 31,
	CIF_ISP20_CID_AUTO_FOCUS_RANGE = 32,
	CIF_ISP20_CID_LOW_LIGHT_CAPTURE = 33,
	CIF_ISP20_CID_AUTO_FOCUS_STATUS = 34,
	CIF_ISP20_CID_METERING_MODE = 35,
        CIF_CUSTOM_CID_3A_LOCK =36 //ASUS_BSP add for icatch AE AWB Lock mode
};
