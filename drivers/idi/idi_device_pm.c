...
#define	NUM_PM_IDI_PERS		25

/* #define	NUM_PM_IDI_PERS		22 */
/* Add two additional peripheral devices for cover charger IC and fuel gauge.
   The device types are IDI_CHG2 and IDI_BAT2.
   They are defined in "idi_interface.h".
<<<<<<< HEAD

   Add another peripheral device for eeprom.
   The device type is IDI_EEP.
   They are defined in "idi_interface.h"
 */
...
static char *pm_dev_name[] = {
	...
	"acc",		/* IDI_ACC */
	"chg",		/* IDI_CHG */
	"chg2",		/* IDI_CHG2 */ /* For ASUS cover */
	"bat",		/* IDI_BAT */
	"bat2",		/* IDI_BAT2 */ /* For ASUS cover */
	"eep",		/* IDI_EEP */
	"ccd",		/* IDI_CCD */
	"bnt",		/* IDI_BNT */
	"dbg",		/* IDI_DBG */
...
static char *pm_dev_state[][NUM_PM_IDI_STATES] = {
	...
	{""},	/* IDI_ACC */
	{""},	/* IDI_CHG */
	{""},	/* IDI_CHG2 */ /* For ASUS cover */
	{""},	/* IDI_BAT */
	{""},	/* IDI_BAT2 */ /* For ASUS cover */
	{""},	/* IDI_EEP */
	{""},	/* IDI_CCD */
	{""},	/* IDI_BNT */
	{""},	/* IDI_DBG */
