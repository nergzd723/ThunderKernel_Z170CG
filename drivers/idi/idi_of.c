...
static struct idi_peripheral_type_lut type_lut[] = {
	...
	{.type = IDI_CCD, .property_value = "intel,idi,sn200007"},
	{.type = IDI_CHG2, .property_value = "intel,idi,smb358"},
	{.type = IDI_BAT2, .property_value = "intel,idi,ug31xx"},
	{.type = IDI_EEP, .property_value = "intel,idi,ht24lc02"},
